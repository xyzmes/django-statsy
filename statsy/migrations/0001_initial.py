    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(related_name='statsy_object_list', verbose_name=b'event', blank=True, to='statsy.StatsyEvent', null=True, on_delete=models.CASCADE)),
                ('group', models.ForeignKey(related_name='statsy_object_list', verbose_name=b'group', blank=True, to='statsy.StatsyGroup', null=True, on_delete=models.CASCADE)),
                ('user', models.ForeignKey(related_name='statsy_object_list', verbose_name=b'user', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)),
            ],
            options={
